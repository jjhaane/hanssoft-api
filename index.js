...
const settings = {
  name: "Hanssoft Api's",
  description: "Hanssoft Api is a simple and lightweight REST API built with Next.js, designed to provide easy access to various web functionalities.", 
  apiSettings: {
    creator: "Hanssoft",
    apikey: ["hans"]
  },
    linkWhatsapp: "https://whatsapp.com/channel/0029VbBq1aN05MUeZ773OH3I",
...
app.use((req, res, next) => {
  ...
  res.json = function (data) {
    if (data && typeof data === 'object') {
      const responseData = {
        status: data.status,
        creator: settings.apiSettings.creator || "Created Using Hanssoft",
        ...data
      };
